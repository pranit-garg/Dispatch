...
Every Dispatch worker gets a verifiable, portable identity and reputation score onchain through [ERC-8004](https://github.com/parity-asia/ERC-8004). Reputation lives on Monad regardless of which chain the job settles on. Workers take their track record anywhere — none of it is locked to Dispatch.
