...
- **150K+ Seeker phones** — Pre-ordered devices with Solana wallets (Phantom via MWA). These are the supply-side workers.
- **Staking** — BOLT staking program for tier-based matching priority.
- **DeFi** — Jupiter, Raydium, Phantom — immediate liquidity and trading for workers.
...
You can't reach 150K+ Seeker phones on Monad — they have Solana wallets, use Phantom, and interact via Mobile Wallet Adapter. Asking mobile workers to bridge to an EVM chain adds friction that kills adoption.
