---
title: Architecture
description: Dispatch system architecture. Coordinators, workers, seekers, SQLite storage, and the full job data flow.
---
...
- A CLI tool like the `dispatch-demo`
...
One port, one process, one URL for both REST and WebSocket.
