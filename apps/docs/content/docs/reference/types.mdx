...
description: All TypeScript types from @dispatch/protocol, including JobType, Policy, PrivacyClass enums, interfaces, and pricing functions.
---
...
These are also exported from `@dispatch/protocol`. See the [WebSocket Protocol](/docs/api/websocket) page for full documentation.
