---
title: Run a Seeker
description: Submit compute jobs to the Dispatch network using the ComputeRouter SDK. LLM inference, tasks, and private jobs.
---
...
2. Submits the job to the right tier endpoint
...
// AUTO (default) - LLM_INFER resolves to FAST, TASK resolves to CHEAP
