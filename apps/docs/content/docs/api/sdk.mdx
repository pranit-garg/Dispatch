---
title: SDK Reference
description: ComputeRouter SDK reference. Submit AI jobs to decentralized workers with automatic hosted BYOK fallback.
---
...
The hosted adapters call provider APIs directly, with no coordinator and no x402 payments. The `route` field in the result shows which hosted provider was used.
