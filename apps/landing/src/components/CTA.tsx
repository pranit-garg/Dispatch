    ...
    <section className="relative overflow-hidden section-divider px-6 py-20 md:py-28">
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        >
          ...
          <span className="inline-flex items-center gap-2 rounded-lg border border-border px-6 py-3 font-medium text-text-muted transition-colors hover:border-border-bright hover:text-text">
            <svg
              className="h-4 w-4"
              fill="none"
              stroke="currentColor"
